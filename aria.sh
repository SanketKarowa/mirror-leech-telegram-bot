...
aria2c --allow-overwrite=true --auto-file-renaming=true --bt-enable-lpd=true --bt-detach-seed-only=true \
       ...
       --rpc-secret=testing123 --keep-unfinished-download-result=true --save-not-found=true --save-session=/usr/src/app/aria2c.session \
       --save-session-interval=60 --dir=/usr/src/app/downloads